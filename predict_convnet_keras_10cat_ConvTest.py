...
TRAIN_LOSS_SF_PATH = 'loss_Conv_test.txt'
...
TXT_OUTPUT_PATH = 'try_10cat_Conv_test.txt'
WRONG_CAT_IMGS_PATH = 'wrong_categorized_Conv_test.json'
IMAGE_OUTPUT_PATH = "img_10cat_COnv_test"
