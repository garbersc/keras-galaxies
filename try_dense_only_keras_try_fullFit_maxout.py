...
MOMENTUM = 0.9
WEIGHT_DECAY = 0.0
N_TRAIN =  100 #num_train# 2000#1008#10000 # 30000 # this should be a multiple of the batch size, ideally.
EPOCHS = 100
...
TRAIN_LOSS_SF_PATH = "trainingNmbrs_keras_ev1.txt"

#TARGET_PATH = "predictions/final/try_convnet.csv"
WEIGHTS_PATH = "analysis/final/try_convent_keras_ev1.h5"
...
model.add(Dense(output_dim=2048 , activation='tanh', weights = dense_weight_init_values(model.output_shape[-1],2048) )) 
