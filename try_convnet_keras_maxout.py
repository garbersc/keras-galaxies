...
TRAIN_LOSS_SF_PATH = "trainingNmbrs_keras_maxout._test.txt"

ANALYSIS_PATH = "analysis/final/try_convent_keras_maxout_test.pkl"
WEIGHTS_PATH = "analysis/final/try_convent_keras_maxout_weights_test.h5"
...
model.add(MaxoutDense(output_dim=2048, nb_feature=2 ,weights = dense_weight_init_values(4096,2048) )) 
model.add(Dropout(0.5))

model.add(MaxoutDense(output_dim=2048, nb_feature=2 ,weights = dense_weight_init_values(2048,2048) )) 
model.add(Dropout(0.5))
